...
export default function ProgenitorCard (progenitor: Progenitor) {
    ...
    return (
        ...
        >
            <div title="Mastery Rank" className="ListItem_progenitorElement" style={{backgroundImage: `url(/assets/elements/${progenitor.elementName}.png)`}}>
                {/*<img draggable={false} src={`/assets/elements/${progenitor.elementName}.png`}*/}
            ...
            <div className="ListItem_itemTexture">
                <div style={{width: "100%", display: "flex", justifyContent: "center"}}>
                    <img draggable={false} src={`/assets/warframes/${progenitor.warframeName}.png`}
